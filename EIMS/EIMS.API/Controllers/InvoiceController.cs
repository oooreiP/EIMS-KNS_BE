...
namespace EIMS.API.Controllers
{
    ...
    public class InvoiceController : BaseApiController
    {
        ...
        {
            var command = new CreateAdjustmentInvoiceCommand { TemplateId = dto.TemplateId,InvoiceStatusId = dto.InvoiceStatusId, OriginalInvoiceId = dto.OriginalInvoiceId,AdjustmentItems = dto.AdjustmentItems, AdjustmentReason = dto.AdjustmentReason,MinuteCode = dto.MinuteCode };
            command.RootPath = _env.ContentRootPath;
            var result = await _mediator.Send(command);
