...
namespace EIMS.Infrastructure.Migrations
{
    ...
    [Migration("20260113181559_SeedETemplate")]
    partial class SeedETemplate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryType = "Goods",
                            Code = "HH",
                            CreatedDate = new DateTime(2026, 1, 13, 18, 15, 54, 277, DateTimeKind.Utc).AddTicks(6426),
                        ...
                        new
                        {
                            ...
                            Code = "DV",
                            CreatedDate = new DateTime(2026, 1, 13, 18, 15, 54, 277, DateTimeKind.Utc).AddTicks(6435),
                        ...
                        new
                        {
                            ...
                            Code = "SW",
                            CreatedDate = new DateTime(2026, 1, 13, 18, 15, 54, 277, DateTimeKind.Utc).AddTicks(6438),
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.EmailTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Category = "invoice",
                            CreatedAt = new DateTime(2026, 1, 13, 18, 15, 55, 79, DateTimeKind.Utc).AddTicks(4417),
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            Category = "invoice",
                            CreatedAt = new DateTime(2026, 1, 13, 18, 15, 55, 79, DateTimeKind.Utc).AddTicks(4421),
                            IsActive = true,
                            IsSystemTemplate = true,
                            LanguageCode = "en",
                        ...
                        new
                        {
                            ...
                            Category = "payment",
                            CreatedAt = new DateTime(2026, 1, 13, 18, 15, 55, 79, DateTimeKind.Utc).AddTicks(4424),
                            IsActive = true,
                            IsSystemTemplate = true,
                            LanguageCode = "vi",
                        ...
                        new
                        {
                            ...
                            BodyContent = "<div style=''font-family:Arial, sans-serif; padding: 20px; border: 1px solid #ddd; max-width: 600px; margin: 0 auto;''>\r\n    <h2 style=''color:#007BFF;''>Xin chào {{CustomerName}},</h2>\r\n    <p style=''background:#f0f8ff; padding:10px; border-left:4px solid #007BFF; font-style:italic;''>{{Message}}</p>\r\n    <p>Chúng tôi xin thông báo hóa đơn điện tử đã được phát hành:</p>\r\n    <table style=''width:100%; margin:15px 0;''>\r\n        <tr><td><strong>Số hóa đơn:</strong></td><td>#{{InvoiceNumber}}</td></tr>\r\n        <tr><td><strong>Ký hiệu:</strong></td><td>{{Serial}}</td></tr>\r\n        <tr><td><strong>Ngày phát hành:</strong></td><td>{{IssuedDate}}</td></tr>\r\n        <tr><td><strong>Tổng tiền:</strong></td><td style=''color:#D63384; font-weight:bold;''>{{TotalAmount}}</td></tr>\r\n    </table>\r\n    \r\n    <div style=''background-color: #f8f9fa; padding: 10px; margin: 10px 0; border: 1px dashed #007bff;''>\r\n         <strong>Mã tra cứu: </strong> <span style=''font-family: monospace; font-size: 1.2em; color: #007bff;''>{{LookupCode}}</span>\r\n    </div>\r\n\r\n    <p>📂 <strong>File đính kèm:</strong></p>\r\n    <ul>{{AttachmentList}}</ul>\r\n    <p style=''color:#777; font-size:12px;''>Trân trọng,<br>EIMS Team</p>\r\n</div>",
                            Category = "invoice",
                            CreatedAt = new DateTime(2026, 1, 13, 18, 15, 55, 79, DateTimeKind.Utc).AddTicks(4426),
                            IsActive = true,
                            IsSystemTemplate = true,
                            LanguageCode = "vi",
                        ...
                        new
                        {
                            ...
                            Category = "minutes",
                            CreatedAt = new DateTime(2026, 1, 13, 18, 15, 55, 79, DateTimeKind.Utc).AddTicks(4428),
                            IsActive = true,
                            IsSystemTemplate = true,
                            LanguageCode = "vi",
                        ...
                        new
                        {
                            ...
                            Category = "minutes",
                            CreatedAt = new DateTime(2026, 1, 13, 18, 15, 55, 79, DateTimeKind.Utc).AddTicks(4430),
                            IsActive = true,
                            IsSystemTemplate = true,
                            LanguageCode = "vi",
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryID = 1,
                            Code = "HH0001",
                            CreatedDate = new DateTime(2026, 1, 13, 18, 15, 54, 277, DateTimeKind.Utc).AddTicks(6477),
                        ...
                        new
                        {
                            ...
                            CategoryID = 2,
                            Code = "DV001",
                            CreatedDate = new DateTime(2026, 1, 13, 18, 15, 54, 277, DateTimeKind.Utc).AddTicks(6482),
                        ...
                        new
                        {
                            ...
                            CategoryID = 3,
                            Code = "SW001",
                            CreatedDate = new DateTime(2026, 1, 13, 18, 15, 54, 277, DateTimeKind.Utc).AddTicks(6485),
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 1,
                            CreatedAt = new DateTime(2026, 1, 13, 18, 15, 54, 439, DateTimeKind.Utc).AddTicks(8982),
                            Email = "admin@eims.local",
                            FullName = "Admin User",
                            IsActive = true,
                            IsPasswordChangeRequired = false,
                            PasswordHash = "$2a$11$p3G074EaSdegIT3/9AbLqu/Xry/xSFz/XfAD6Hn3IeNmNz8yj9Yla",
                        ...
                        {
                            UserID = 2,
                            CreatedAt = new DateTime(2026, 1, 13, 18, 15, 54, 606, DateTimeKind.Utc).AddTicks(2001),
                            Email = "accountant@eims.local",
                            FullName = "Accountant User",
                            IsActive = true,
                            IsPasswordChangeRequired = false,
                            PasswordHash = "$2a$11$0cINrt5tsuEU4a9EekM96e1B9lSSGcRaSIv8dyh22pOWD5u3fZuMa",
                        ...
                        {
                            UserID = 3,
                            CreatedAt = new DateTime(2026, 1, 13, 18, 15, 54, 762, DateTimeKind.Utc).AddTicks(3803),
                            Email = "sale@eims.local",
                            FullName = "Sales User",
                            IsActive = true,
                            IsPasswordChangeRequired = false,
                            PasswordHash = "$2a$11$mCujt0azcZfshWFWpi.I1O1yHk9RxLgwxUsieHSvn87Uyo5KRLUBS",
                        ...
                        {
                            UserID = 4,
                            CreatedAt = new DateTime(2026, 1, 13, 18, 15, 54, 920, DateTimeKind.Utc).AddTicks(6742),
                            Email = "hod@eims.local",
                            FullName = "Head Dept User",
                            IsActive = true,
                            IsPasswordChangeRequired = false,
                            PasswordHash = "$2a$11$1OZQRvEAo1sLIpINyC0T0u9DVe6lbCohp5wEGaMa3jaX5CEjnl4UK",
                        ...
                        {
                            UserID = 5,
                            CreatedAt = new DateTime(2026, 1, 13, 18, 15, 55, 76, DateTimeKind.Utc).AddTicks(5513),
                            Email = "customer@eims.local",
                            FullName = "Customer User",
                            IsActive = true,
                            IsPasswordChangeRequired = false,
                            PasswordHash = "$2a$11$TgluXWGDE8eFlww52t6zUuKcaa0RmbM1jdGZ6u0Vg6ZzlUa4wP4Ym",
